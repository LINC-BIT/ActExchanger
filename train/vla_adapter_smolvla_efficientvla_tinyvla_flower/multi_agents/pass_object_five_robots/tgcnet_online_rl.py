...
class FiveVLATGCNetOnlineAgent(FiveVLATGCNetAdapterAgent):
...
mappo_online_rl.AGENT_CLS = FiveVLATGCNetOnlineAgent
mappo_online_rl.OPTIMIZER_FN = build_optimizer
mappo_online_rl.ALGO_NAME = "tgcnet"
mappo_online_rl.MODEL_NAME = "mixed_five_vla_pass_object_tgcnet"
