...
case "${ALGO}" in
  mappo|ppo)
    ENTRY="${PROJECT_ROOT}/train/vla_adapter_smolvla_efficientvla_tinyvla_flower/multi_agents/pass_object_five_robots/mappo_online_rl.py"
    ;;
  mat|dicg|tgcnet|comatrack|magrpo|maporl|mpdf|maple)
    ENTRY="${PROJECT_ROOT}/train/vla_adapter_smolvla_efficientvla_tinyvla_flower/multi_agents/pass_object_five_robots/${ALGO}_online_rl.py"
    ;;
  *)
...
SCRIPT_DIR="${PROJECT_ROOT}/train/vla_adapter_smolvla_efficientvla_tinyvla_flower/multi_agents/pass_object_five_robots"
