...
RUN_DIR="${RUN_DIR-ckpt/PassObjectFiveRobots-v1_online_wo_ag/ppo/panda_so100_widowx_xarm6_inspire/mixed_five_vla_100m_pass_object_mappo/20260711-193017}"
BASELINE_RUN_DIR="${BASELINE_RUN_DIR-ckpt/PassObjectFiveRobots-v1_online_baseline/ppo/panda_so100_widowx_xarm6_inspire/mixed_five_vla_100m_pass_object_mappo/20260710-063926}"
DICG_RUN_DIR="${DICG_RUN_DIR-ckpt/PassObjectFiveRobots-v1_online_baseline/dicg/panda_so100_widowx_xarm6_inspire/mixed_five_vla_100m_dicg/20260711-121607}"
MAT_RUN_DIR="${MAT_RUN_DIR-ckpt/PassObjectFiveRobots-v1_online_baseline/mat/panda_so100_widowx_xarm6_inspire/mixed_five_vla_100m_mat/20260711-124912}"
TGCNET_RUN_DIR="${TGCNET_RUN_DIR-ckpt/PassObjectFiveRobots-v1_online_baseline/tgcnet/panda_so100_widowx_xarm6_inspire/mixed_five_vla_100m_tgcnet/20260711-124920}"
MAPLE_RUN_DIR="${MAPLE_RUN_DIR-ckpt/PassObjectFiveRobots-v1_online_baseline/maple/panda_so100_widowx_xarm6_inspire/mixed_five_vla_100m_maple/20260711-182233}"
COMATRACK_RUN_DIR="${COMATRACK_RUN_DIR-ckpt/PassObjectFiveRobots-v1_online_baseline/comatrack/panda_so100_widowx_xarm6_inspire/mixed_five_vla_100m_comatrack/20260711-183439}"
MAPORL_RUN_DIR="${MAPORL_RUN_DIR-ckpt/PassObjectFiveRobots-v1_online_baseline/maporl/panda_so100_widowx_xarm6_inspire/mixed_five_vla_100m_maporl_planner/20260711-182919}"
MPDF_RUN_DIR="${MPDF_RUN_DIR-ckpt/PassObjectFiveRobots-v1_online_baseline/mpdf/panda_so100_widowx_xarm6_inspire/mixed_five_vla_100m_mpdf_planner/20260711-183025}"
...
usage() {
  cat <<'EOF'
Usage:
  bash train/vla_adapter_smolvla_efficientvla_tinyvla_flower/multi_agents/pass_object_five_robots/run_draw_online_rl_acc_true.sh \
...
Defaults:
  ...
  ckpt/PassObjectFiveRobots-v1_online_baseline/<algo>/panda_so100_widowx_xarm6_inspire/mixed_five_vla_100m_<algo>/
...
CMD=(
  "${PYTHON_BIN}"
  "${SCRIPT_DIR}/draw_online_rl_acc_true.py"
  --baseline-run-dir "${BASELINE_RUN_DIR}"
  --output "${OUTPUT}"
  --tag "${TAG}"
  --title "${TITLE}"
