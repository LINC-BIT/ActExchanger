...
MODEL_NAME = "mixed_five_vla_pass_object_mappo"
ALGO_NAME = "ppo"
...
def parse_args():
    ...
    parser.add_argument("--mix-train-online-envs", action="store_true")
    ...
    args.mix_train_online_envs = extras.mix_train_online_envs
