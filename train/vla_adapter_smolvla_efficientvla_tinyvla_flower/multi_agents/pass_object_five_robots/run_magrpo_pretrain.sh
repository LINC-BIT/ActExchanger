...
MAGRPO_GROUP_SIZE="${MAGRPO_GROUP_SIZE:-8}"
...
CMD=(
  "${PYTHON_BIN}" ${PROJECT_ROOT}/train/vla_adapter_smolvla_efficientvla_tinyvla_flower/multi_agents/pass_object_five_robots/magrpo_pretrain.py
