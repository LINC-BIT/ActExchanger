...
INIT_AGENT_PATH="${INIT_AGENT_PATH:-ckpt/TwoRobotStackCubeUR10e-v1_ag/ppo/panda_ur10e_panda_gripper/vla_adapter_openvla_mappo/20260701-191720/latest_agent.pt}"
...
CMD=(
  "${PYTHON_BIN}" ${PROJECT_ROOT}/train/vla_adapter_openvla/multi_agents/two_robot_stack/mappo_online_rl.py
