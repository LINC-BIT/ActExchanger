...
BC_SFT_CKPT_PATH="${BC_SFT_CKPT_PATH:-ckpt/TwoRobotStackCubeUR10e-v1/sft/panda_ur10e_panda_gripper/vla_adapter_openvla_sft/20260726-180924/latest_agent.pt}"
...
RESUME_DIR="${RESUME_DIR:-ckpt/TwoRobotStackCubeUR10e-v1/ppo/panda_ur10e_panda_gripper/vla_adapter_openvla_mappo/20260628-184332}"
...
CMD=(
  "${PYTHON_BIN}" ${PROJECT_ROOT}/train/vla_adapter_openvla/multi_agents/two_robot_stack/mappo_pretrain.py
