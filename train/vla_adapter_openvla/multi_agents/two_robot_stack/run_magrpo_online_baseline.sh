...
INIT_AGENT_PATH="${INIT_AGENT_PATH:-ckpt/TwoRobotStackCubeUR10e-v1/magrpo/panda_ur10e_panda_gripper/vla_adapter_openvla_magrpo_planner/20260728-111510/latest_agent.pt}"
...
CMD=(
  "${PYTHON_BIN}" ${PROJECT_ROOT}/train/vla_adapter_openvla/multi_agents/two_robot_stack/magrpo_online_rl.py
