...
INIT_AGENT_PATH="${INIT_AGENT_PATH:-ckpt/TwoRobotStackCubeUR10e-v1/mpdf/panda_ur10e_panda_gripper/vla_adapter_openvla_mpdf_planner/20260728-111518/latest_agent.pt}"
...
CMD=(
  "${PYTHON_BIN}" ${PROJECT_ROOT}/train/vla_adapter_openvla/multi_agents/two_robot_stack/mpdf_online_rl.py
