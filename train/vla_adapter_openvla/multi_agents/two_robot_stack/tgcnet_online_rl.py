...
from train.vla_adapter_openvla.multi_agents.two_robot_stack.tgcnet_pretrain import (
    OpenVLATGCNetAdapterAgent,
)
...
class OpenVLATGCNetOnlineAgent(OpenVLATGCNetAdapterAgent):
        ...
        optimizer.add_param_group(
            {
                ...
                "group_name": "tgcnet_adapter",
            }
        )
    return optimizer


mappo_online_rl.AGENT_CLS = OpenVLATGCNetOnlineAgent
mappo_online_rl.OPTIMIZER_FN = build_optimizer
mappo_online_rl.ALGO_NAME = "tgcnet"
mappo_online_rl.MODEL_NAME = "vla_adapter_openvla_tgcnet"

main = mappo_online_rl.main
parse_args = mappo_online_rl.parse_args


SmolVLATGCNetOnlineAgent = OpenVLATGCNetOnlineAgent
