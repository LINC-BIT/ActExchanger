...
MAPPO_CKPT_PATH="${MAPPO_CKPT_PATH:-ckpt/TwoRobotStackCubeUR10e-v1/ppo/panda_ur10e_panda_gripper/vla_adapter_openvla_mappo/20260628-184332/latest_agent.pt}"
...
RESUME_DIR="${RESUME_DIR:-ckpt/TwoRobotStackCubeUR10e-v1_ag/ppo/panda_ur10e_panda_gripper/vla_adapter_openvla_mappo/20260701-191720}"
...
CMD=(
  "${PYTHON_BIN}" ${PROJECT_ROOT}/train/vla_adapter_openvla/multi_agents/two_robot_stack/mappo_feature_aggregator_pretrain.py
  --task-name TwoRobotStackCubeUR10e-v1
  --ckpt-task-name TwoRobotStackCubeUR10e-v1_ag
