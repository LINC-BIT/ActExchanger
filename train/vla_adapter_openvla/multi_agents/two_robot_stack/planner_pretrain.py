...
from train.vla_adapter_openvla.multi_agents.two_robot_stack.planner_low_level_adapter import (
...
MODEL_NAME = "vla_adapter_openvla_maporl_planner"
ALGO_NAME = "maporl"
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="smolvla",
        choices=["smolvla", CANONICAL_MIXED_MODEL_BACKBONE, LEGACY_MIXED_MODEL_BACKBONE],
    )
