...
INIT_AGENT_PATH="${INIT_AGENT_PATH:-ckpt/TwoRobotStackCubeUR10e-v1/dicg/panda_ur10e_panda_gripper/vla_adapter_openvla_mappo/20260727-174423/latest_agent.pt}"
...
CMD=(
  "${PYTHON_BIN}" ${PROJECT_ROOT}/train/vla_adapter_openvla/multi_agents/two_robot_stack/dicg_online_rl.py
