...
class OpenVLATGCNetAdapterAgent(FrozenMixedBackboneAdapterAgent):
...
mappo_pretrain.MixedTinyVLAAdapterOpenVLASFTAgent = OpenVLATGCNetAdapterAgent
mappo_pretrain.build_mixed_mappo_optimizer = build_optimizer
mappo_pretrain.ALGO_NAME = "tgcnet"
mappo_pretrain.MODEL_NAME = "vla_adapter_openvla_tgcnet"

parse_args = mappo_pretrain.parse_args


SmolVLATGCNetAdapterAgent = OpenVLATGCNetAdapterAgent
