...
class OpenVLADICGAdapterAgent(FrozenMixedBackboneAdapterAgent):
...
mappo_pretrain.MixedTinyVLAAdapterOpenVLASFTAgent = OpenVLADICGAdapterAgent
mappo_pretrain.build_mixed_mappo_optimizer = build_optimizer
mappo_pretrain.ALGO_NAME = "dicg"
mappo_pretrain.MODEL_NAME = "vla_adapter_openvla_dicg"

parse_args = mappo_pretrain.parse_args


SmolVLADICGAdapterAgent = OpenVLADICGAdapterAgent
