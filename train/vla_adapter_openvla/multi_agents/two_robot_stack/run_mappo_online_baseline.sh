...
INIT_AGENT_PATH="${INIT_AGENT_PATH:-ckpt/TwoRobotStackCubeUR10e-v1/ppo/panda_ur10e_panda_gripper/vla_adapter_openvla_mappo/20260628-184332/latest_agent.pt}"
