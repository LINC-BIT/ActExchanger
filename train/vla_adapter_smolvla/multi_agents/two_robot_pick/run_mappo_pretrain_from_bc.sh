...
RESUME_DIR="${RESUME_DIR:-ckpt/TwoRobotPickCube-v2/ppo/pandas_pandas/vla_adapter_smolvla_mappo/20260628-184332}"
...
CMD=(
  "${PYTHON_BIN}" ${PROJECT_ROOT}/train/vla_adapter_smolvla/multi_agents/two_robot_pick/mappo_pretrain.py
