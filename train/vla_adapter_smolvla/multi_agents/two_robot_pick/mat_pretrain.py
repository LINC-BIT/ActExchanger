...
class SmolVLAMATAdapterAgent(FrozenMixedBackboneAdapterAgent):
...
mappo_pretrain.MixedTinyVLAAdapterSmolVLASFTAgent = SmolVLAMATAdapterAgent
...
mappo_pretrain.MODEL_NAME = "vla_adapter_smolvla_mat"
