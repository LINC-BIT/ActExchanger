...
class SmolVLAMapleAdapterAgent(MixedTinyVLAAdapterSmolVLASFTAgent):
    def __init__(
        self,
        *args,
        latent_layers: int = 2,
...
class SmolVLAMapleOnlineAgent(SmolVLAMapleAdapterAgent):
...
def build_optimizer(args, agent: SmolVLAMapleAdapterAgent) -> torch.optim.Optimizer:
    maple_param_groups = [
        {
