...
from train.vla_adapter_smolvla.multi_agents.two_robot_pick.dicg_pretrain import (
    SmolVLADICGAdapterAgent,
)
...
class SmolVLADICGOnlineAgent(SmolVLADICGAdapterAgent):
...
mappo_online_rl.AGENT_CLS = SmolVLADICGOnlineAgent
mappo_online_rl.OPTIMIZER_FN = build_optimizer
mappo_online_rl.ALGO_NAME = "dicg"
mappo_online_rl.MODEL_NAME = "vla_adapter_smolvla_dicg"
