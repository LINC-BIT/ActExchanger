...
INIT_AGENT_PATH="${INIT_AGENT_PATH:-ckpt/TwoRobotPickCube-v2/mpdf/pandas_pandas/vla_adapter_smolvla_mpdf_planner/20260701-125316/latest_agent.pt}"
...
CMD=(
  "${PYTHON_BIN}" ${PROJECT_ROOT}/train/vla_adapter_smolvla/multi_agents/two_robot_pick/mpdf_online_rl.py
