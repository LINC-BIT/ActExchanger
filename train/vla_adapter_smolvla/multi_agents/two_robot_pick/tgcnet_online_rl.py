...
from train.vla_adapter_smolvla.multi_agents.two_robot_pick.tgcnet_pretrain import (
    SmolVLATGCNetAdapterAgent,
)
...
class SmolVLATGCNetOnlineAgent(SmolVLATGCNetAdapterAgent):
...
mappo_online_rl.AGENT_CLS = SmolVLATGCNetOnlineAgent
mappo_online_rl.OPTIMIZER_FN = build_optimizer
mappo_online_rl.ALGO_NAME = "tgcnet"
mappo_online_rl.MODEL_NAME = "vla_adapter_smolvla_tgcnet"
