...
DATASET_CACHE_PATH="${DATASET_CACHE_PATH:-ckpt/PlaceCucumber-v1/sft/panda_widowx_widowx/vla_adapter_smolvla_efficientvla_sft/20260708-101944/expert_sft_dataset.pt}"
RESUME_DIR="${RESUME_DIR:-}"
EXPERT_AGENT_PATH="${EXPERT_AGENT_PATH:-ckpt/PlaceCucumber-v1/ppo/panda_widowx_widowx/toy_cnn_place_cucumber_mappo_pretrain/20260705-072956/best_agent.pt}"
...
CMD=(
  "${PYTHON_BIN}" ${PROJECT_ROOT}/train/vla_adapter_smolvla_efficientvla/multi_agents/place_cucumber/bc_pretrain.py
