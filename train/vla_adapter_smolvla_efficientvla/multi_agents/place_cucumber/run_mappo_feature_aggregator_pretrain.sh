...
MAPPO_CKPT_PATH="${MAPPO_CKPT_PATH:-ckpt/PlaceCucumber-v1/ppo/panda_widowx_widowx/vla_adapter_smolvla_efficientvla_mappo/20260709-124052/best_agent.pt}"
MODEL_BACKBONE="${MODEL_BACKBONE:-mixed_tiny_vla_smolvla_efficientvla}"
MODEL_DIR="${MODEL_DIR:-}"
...
RESUME_DIR="${RESUME_DIR:-ckpt/PlaceCucumber-v1_ag/ppo/panda_widowx_widowx/vla_adapter_smolvla_efficientvla_mappo/20260711-144613}"
...
CMD=(
  "${PYTHON_BIN}" ${PROJECT_ROOT}/train/vla_adapter_smolvla_efficientvla/multi_agents/place_cucumber/mappo_feature_aggregator_pretrain.py
  --task-name PlaceCucumber-v1
  --ckpt-task-name PlaceCucumber-v1_ag
