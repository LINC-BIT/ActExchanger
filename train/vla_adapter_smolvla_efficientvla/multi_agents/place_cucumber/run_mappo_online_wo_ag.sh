...
INIT_AGENT_PATH="${INIT_AGENT_PATH:-ckpt/PlaceCucumber-v1_ag/ppo/panda_widowx_widowx/vla_adapter_smolvla_efficientvla_mappo/20260711-144613/latest_agent.pt}"
MODEL_DIR="${MODEL_DIR:-}"
...
CMD=(
  "${PYTHON_BIN}" ${PROJECT_ROOT}/train/vla_adapter_smolvla_efficientvla/multi_agents/place_cucumber/mappo_online_rl.py
