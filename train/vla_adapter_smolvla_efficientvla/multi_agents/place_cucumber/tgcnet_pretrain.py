...
mappo_pretrain.MixedTinyVLAAdapterSmolVLAEfficientVLAAgent = ThreeVLATGCNetAdapterAgent
mappo_pretrain.build_mixed_mappo_optimizer = build_optimizer
mappo_pretrain.ALGO_NAME = "tgcnet"
mappo_pretrain.MODEL_NAME = "vla_adapter_smolvla_efficientvla_tgcnet"
