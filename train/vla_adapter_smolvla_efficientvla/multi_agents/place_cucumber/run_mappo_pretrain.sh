...
RESUME_DIR="${RESUME_DIR:-ckpt/PlaceCucumber-v1/ppo/panda_widowx_widowx/vla_adapter_smolvla_efficientvla_mappo/20260709-124052}"
...
CMD=(
  "${PYTHON_BIN}" ${PROJECT_ROOT}/train/vla_adapter_smolvla_efficientvla/multi_agents/place_cucumber/mappo_pretrain.py
