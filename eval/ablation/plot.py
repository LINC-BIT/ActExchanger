...
CHOICE_LABEL_MAP = {
    "raw features": "unprocessed intermediate feature in model",
    "semantic-only features": "semantic-only",
    "spatial-only features": "spatial-only",
    "semantic-spatial hybrid features": "semantic and spatial",
    "original length": "original length",
    "mdl": "MDL",
    "multiple unfused features per action": "five vectors per action",
    "single fused feature per action": "single vector per action",
    "no aggregation": "never aggregated",
    "current-forward aggregation": "aggregated from current-forward features",
    "random aggregation": "aggregated from random features",
    "same-action aggregation": "aggregated from same-action features",
}
